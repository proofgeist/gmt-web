...
export const DEFAULT_SIGNUP_EMAIL = "MyGMT <welcome@signup.mygmt.com>";
export const DEFAULT_RELEASE_INBOX =
  "gmt-release@globalmarinetransportation.com";
  export const DEFAULT_FROM_EMAIL = "MyGMT <gmt-bookings@mygmt.com>";